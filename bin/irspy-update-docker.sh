...
do
   ...
   IRSPY_COUNTER_FILE=/home/indexdata/irspy/zebra/db/counter YAZ_LOG=irspy,irspy_test,irspy_task nice -10 time perl -I../lib irspy.pl -n 50 -d -M 3500 -f'cql.allRecords=1 not zeerex.disabled = 1' -t $irspy_test -r ../etc/dallas.rules -m 9,$i irspy-zebra:8018/IR-Explain---1 > $logfile 2>&1
